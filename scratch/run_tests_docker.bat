...
docker exec -w /AstrBot/data/plugins/astrbot_plugin_text_roguelike -e PYTHONPATH=/AstrBot/data/plugins:/AstrBot/data/plugins/astrbot_plugin_text_roguelike -t astrbot-test-env python /AstrBot/data/plugins/astrbot_plugin_text_roguelike/scratch/test_flow.py
if %ERRORLEVEL% neq 0 (
    echo.
